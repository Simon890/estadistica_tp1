...
# disponible en ese momento en el dep�sito) y midieron el contenido de vitamina D.
...
setwd("ingresar tu working directory") #Cambiar al que corresponda
...
# Trazamos una linea recta que determinar� si el porcentaje de pildoras que cumplen
